...
@section('content')
	...
	<!-- END breadcrumb -->
	<!-- BEGIN page-header -->
	<h1 class="page-header">DASHBOARD {{ $toko->nama_toko }} <small></small></h1>
	<!-- END page-header -->
	...
	<div class="row">
		...
		<div class="col-xl-3 col-md-6">
			<div class="widget widget-stats bg-info">
				...
				<div class="stats-link">
					<a href="{{ route('kategori.index') }}">View Detail <i class="fa fa-arrow-alt-circle-right"></i></a>
				</div>
			</div>
		</div>
		...
		<div class="col-xl-3 col-md-6">
			<div class="widget widget-stats bg-blue">
				...
				<div class="stats-link">
					<a href="{{ route('produk.index') }}">View Detail <i class="fa fa-arrow-alt-circle-right"></i></a>
				</div>
			</div>
		</div>
		...
		<div class="col-xl-3 col-md-6">
			<div class="widget widget-stats bg-orange">
				...
				<div class="stats-link">
					<a href="{{ route('pengeluaran.index') }}">View Detail <i class="fa fa-arrow-alt-circle-right"></i></a>
				</div>
			</div>
		</div>
